...
<form method="get" action="${pageContext.request.contextPath}/admin/add-products.jsp">
    <button type="submit"><fmt:message key="add.product" bundle="${lang}"/></button>
</form>
<form method="get" action="${pageContext.request.contextPath}/users">
    <button type="submit"><fmt:message key="users.title" bundle="${lang}"/></button>
</form>
<form method="get" action="${pageContext.request.contextPath}/usersOrders">
    <button type="submit"><fmt:message key="orders" bundle="${lang}"/></button>
</form>
    ...
    <c:forEach items="${requestScope.allProducts}" var="product">
        <tr>
            ...
            <form method="get"
                ...
                <td><input type="hidden" name="productIdDelete" id="productIdDelete" min=1 value="${product.id}"></td>
                <td style="text-align: right"><input class="button" type="submit" value="<fmt:message key="delete" bundle="${lang}"/>"/></td>

            </form>
            <form method=get"
                  action="${pageContext.request.contextPath}/find-for-update">

                <td><input type="hidden" name="updateId" id="updateId" min=1 value="${product.id}"></td>
                <td style="text-align: right"><input class="button" type="submit" value="<fmt:message key="edit" bundle="${lang}"/>"/></td>
            </form>
        </tr>
    </c:forEach>
    </tbody>
