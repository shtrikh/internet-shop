...
<form method="get" action="${pageContext.request.contextPath}/basket">
    <button type="submit"><fmt:message key="to.basket" bundle="${lang}"/></button>
</form>
<form method="get" action="${pageContext.request.contextPath}/my-orders">
    <button type="submit"><fmt:message key="my.orders" bundle="${lang}"/></button>
</form>
    ...
    <c:forEach items="${requestScope.allProducts}" var="product">
        <tr>
            ...
            <form method="get"
                ...
                <td><input type="hidden" name="productId" id="productId" min=1 value="${product.id}"></td>
